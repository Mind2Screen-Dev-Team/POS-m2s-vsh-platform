...
**Control repository:**
- `go.mod` — ubah `module` → `github.com/<ORGANIZATION>/<NAMA-REPOSITORY>` (contoh `github.com/<KLIEN-ORGANIZATION>/POS-m2s-vsh-platform`, atau `github.com/Mind2Screen-Dev-Team/POS-m2s-vsh-platform`)
